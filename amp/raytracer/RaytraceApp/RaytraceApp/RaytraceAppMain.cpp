...
RaytraceAppMain::RaytraceAppMain(const std::shared_ptr<DeviceResources>& deviceResources)
...
RaytraceAppMain::~RaytraceAppMain()
{

}

void RaytraceAppMain::CreateWindowSizeDependentResources()
{
    m_impl->CreateWindowSizeDependentResources();
}

void RaytraceAppMain::Update()
{
    m_impl->Update();
}

bool RaytraceAppMain::Render()
{
    return m_impl->Render();
}

// Notifies renderers that device resources need to be released.
void RaytraceAppMain::OnDeviceLost()
{
    m_impl->OnDeviceLost();
}

// Notifies renderers that device resources may now be recreated.
void RaytraceAppMain::OnDeviceRecreated()
{
    m_impl->OnDeviceRecreated();
}

void RaytraceAppMain::PointerWheelChanged(Point const & p, int delta)
{
    m_impl->PointerWheelChanged(p, delta);
}

void RaytraceAppMain::PointerMoved(Point const & p)
{
    m_impl->PointerMoved(p);
}

void RaytraceAppMain::KeyUp(VirtualKey vk)
{
    m_impl->KeyUp(vk);
}
