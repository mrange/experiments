...
module Instanced =
  ...
  type InstancedDeviceIndependent () =
    class
      inherit DeviceIndependent ()
...
//  let background    = Color4(1.F, 1.F, 1.F, 1.F)
  ...
  let deviceIndependent ()    = new InstancedDeviceIndependent ()
  let deviceDependent rf di   = new InstancedDeviceDependent (rf, di)
