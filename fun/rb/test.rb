...
def execute_metaprogram (filename)
    ...
    puts "Extension:"   , metaprogram.extension
    puts "Requires:"    , metaprogram.requires
    puts "Program"      , metaprogram.program_lines
    puts "Template"     , metaprogram.template_lines
    puts "Failures"     , metaprogram.failures
end
